...
async function loadPanels() {
  // 컨테이너 id -> 조각 파일 경로
  const PANEL_SOURCES = {
    panelMonitor: 'pages/monitor.html?v=20260829e',
    panelCuration: 'pages/curation.html?v=20260829e',
    panelGraph: 'pages/graph.html?v=20260829e',
    panelPapers: 'pages/papers.html?v=20260829e',
  };
